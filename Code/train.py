...
def train(X_train, y_train, classificationAlgo="RF" ):
    ...
    print(classification_report(y_train, predictions, target_names=["Negative", "Neutral", "Positive"]))
...
if __name__=="__main__":
    ...
    filepath=f"..{os.sep}Models{os.sep}{algo_name}_parts_{parts_str}.model"
